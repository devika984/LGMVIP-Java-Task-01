...
public class CurrencyConverter implements ActionListener {
    ...
    public CurrencyConverter() {
        ...
        headingLabel.setFont(new Font("Times New Roman", Font.BOLD, 26));
        j.add(headingLabel);
        ...
        amountTextField.setFont(new Font("Times New Roman", Font.BOLD, 14));
        j.add(amountTextField);

        fromLabel = new JLabel("From:");
        fromLabel.setBounds(50, 120, 100, 20);
        fromLabel.setFont(new Font("Times New Roman", Font.BOLD, 14));
        j.add(fromLabel);

        fromComboBox = new JComboBox<>(countries);
        fromComboBox.setBounds(150, 120, 200, 20);
        fromComboBox.setFont(new Font("Times New Roman", Font.BOLD, 14));
        j.add(fromComboBox);

        toLabel = new JLabel("To:");
        toLabel.setBounds(50, 160, 100, 20);
        toLabel.setFont(new Font("Times New Roman", Font.BOLD, 14));
        j.add(toLabel);

        toComboBox = new JComboBox<>(countries);
        toComboBox.setBounds(150, 160, 200, 20);
        toComboBox.setFont(new Font("Times New Roman", Font.BOLD, 14));
        j.add(toComboBox);
        ...
        resultLabel.setBounds(50, 240, 500, 40);
